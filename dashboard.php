...
<html lang="en">
  <head>
    ...
    <!-- External Fonts -->
    <link
      href="https://cdn.fontsource.org/css/google/inter/400,500,600,700.css"
      rel="stylesheet"
    />
    <link
  ...
  <body>
      ...
      <div class="charts-grid">
        ...
        <div class="chart-card animate-in delay-4">
          ...
          <div class="pie-legend">
            ...
            <div class="pie-legend-item">
              <div class="pie-legend-dot" style="background: #f59e0b"></div>
              Overweight
            </div>
            <div class="pie-legend-item">
        ...
        <div class="chart-card animate-in delay-5">
          ...
          <div class="bar-legend">
            ...
            <div class="bar-legend-item">
              <div class="bar-legend-dot" style="background: #f59e0b"></div>
              Overweight
            </div>
          </div>
        </div>
      ...
      <div class="recent-activities animate-in delay-6">
        ...
        <div class="activity-list" id="activityList">
          <div class="activity-item">
            ...
            <div class="activity-content">
              <div class="activity-text">
                <strong>Juan Dela Cruz</strong> – Measurement recorded
              </div>
          ...
          <div class="activity-item">
            ...
            <div class="activity-content">
              <div class="activity-text">
                <strong>Maria Santos</strong> – Feeding attendance marked
              </div>
          ...
          <div class="activity-item">
            ...
            <div class="activity-content">
              <div class="activity-text">
                <strong>Pedro Reyes</strong> – Student profile updated
              </div>
          ...
          <div class="activity-item">
            ...
            <div class="activity-content">
              <div class="activity-text">
                <strong>Anna Lopez</strong> – Baseline recorded
              </div>
    ...
    <div class="modal-overlay" id="measurementModal">
      <div class="modal">
        <h2>Encode Measurement</h2>
        <div class="form-group">
          <label>Select Student</label>
          <select id="measureStudent">
        ...
        <div class="form-row">
          <div class="form-group">
            <label>Height (cm)</label>
            <input type="number" placeholder="Height in cm" id="mHeight" />
          </div>
          <div class="form-group">
            <label>Weight (kg)</label>
            <input type="number" placeholder="Weight in kg" id="mWeight" />
          </div>
        </div>
        <div class="form-group">
          <label>Date</label>
        ...
        <div class="modal-actions">
          <button class="btn btn-cancel">Cancel</button>
          <button class="btn btn-primary">Save Measurement</button>
        </div>
      </div>
    </div>
